...
public class InchtomileScaleActivity extends AppCompatActivity {
    boolean clearInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scaleconverter_inchtomile_scale);
        ...
        textInput = (EditText) findViewById(R.id.intomile_number);
    ...
    private void convertScaleAndDisplay(View view, String stringInput) {
        if(!"".equals(stringInput) && !"0".equals(stringInput)){
            Scale scale = null;
            try {
                scale = convertFromInchtomile(stringInput);
    ...
    private Scale convertFromInchtomile(String stringInput) throws InsufficientParameterException {
        double doubleInput = convertStringToDoubleInput(stringInput);
        Scale scale = new Scale.ScaleBuilder()
                .setInToMileAndConvert(doubleInput)
                .build();
        return scale;
    }
