...
public class MiletoinchScaleActivity extends AppCompatActivity {
    boolean clearInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scaleconverter_miletoinch_scale);
        ...
        textInput = (EditText) findViewById(R.id.miletoinch_number);
    ...
    private void restoreScaleConverted(Bundle savedInstanceState) {
        if(savedInstanceState != null){
            ...
            if(scaleConverted){
                ...
                Scale scale = null;
                try {
                    scale = convertFromMiletoinch(stringInput);
    ...
    private Scale convertFromMiletoinch(String stringInput) throws InsufficientParameterException {
        double doubleInput = convertStringToDoubleInput(stringInput);
        Scale scale = new Scale.ScaleBuilder()
                .setMileToInAndConvert(doubleInput)
                .build();
        return scale;
    }
