...
public class KmtocmScaleActivity extends AppCompatActivity {
    boolean clearInput;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textInput = (EditText) findViewById(R.id.kmtocm_number);
    ...
    private void restoreScaleConverted(Bundle savedInstanceState) {
        if(savedInstanceState != null){
            ...
            if(scaleConverted){
                ...
                Scale scale = null;
                try {
                    scale = convertFromKmtocm(stringInput);
    ...
    private Scale convertFromKmtocm(String stringInput) throws InsufficientParameterException {
        double doubleInput = convertStringToDoubleInput(stringInput);
        Scale scale = new Scale.ScaleBuilder()
                .setKmToCmAndConvert(doubleInput)
                .build();
        return scale;
    }
